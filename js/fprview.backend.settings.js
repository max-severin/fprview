...
var fprviewBackendSettings = (function () { "use strict";
    ...
    initModule = function () {
        ...
        if ($('#fprview_shop_fprview_template_type').val() == 'plugin') {
            ...
            $('#fprview_shop_fprview_custom_template_target_blank, #fprview_shop_fprview_custom_template_color, #fprview_shop_fprview_custom_template_background_color, #fprview_shop_fprview_template_thumbnail_size').closest('.field').show();
        } else if ($('#fprview_shop_fprview_template_type').val() == 'theme') {
            $('#fprview_shop_fprview_template_theme_file').closest('.field').show();
            $('#fprview_shop_fprview_custom_template_target_blank, #fprview_shop_fprview_custom_template_color, #fprview_shop_fprview_custom_template_background_color, #fprview_shop_fprview_template_thumbnail_size').closest('.field').hide();
        }
